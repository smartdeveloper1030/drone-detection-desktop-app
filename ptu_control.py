...
PTU_AZIMUTH_MIN = -30.0  # degrees (PAN_MIN)
PTU_AZIMUTH_MAX = 30.0    # degrees (PAN_MAX)
PTU_PITCH_MIN = -15.0     # degrees (TILT_MIN)
PTU_PITCH_MAX = 15.0      # degrees (TILT_MAX)
...
class PTUControlThread(threading.Thread):
    ...
    def _handle_send_raw_command(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        success = self._send_command(command, wait_for_done=True, timeout=0.5)
        return {'success': success, 'command': command}
